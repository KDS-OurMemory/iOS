//
//  AddFriendsCollectionAdapter.swift
//  OurMemory
//
...
class AddFriendsSearchIDCollectionAdapter: BaseCollectionAdapter {
        ...
        case ADDFRIENDSCOLLECTION_SECTION.ADDFRIENDSSEARCH_SECTION.rawValue:
            if self.isSearchItem {
                if let searchCell = collectionView.dequeueReusableCell(withReuseIdentifier: SearchCollectionViewCell.className(), for: indexPath) as? SearchCollectionViewCell {
                    searchCell.setPlaceholder(placeholder: "사용자 ID로 검색")
    ...
    override func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if self.hasData() {
            ...
            case ADDFRIENDSCOLLECTION_SECTION.ACCEPTADDFRIENDS_SECTION.rawValue,ADDFRIENDSCOLLECTION_SECTION.ADDFRIENDSSEARCH_SECTION.rawValue:
